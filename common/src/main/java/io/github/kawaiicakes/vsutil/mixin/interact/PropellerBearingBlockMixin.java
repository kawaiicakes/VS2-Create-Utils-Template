...
@Pseudo
@Mixin(PropellerBearingBlock.class)
public abstract class PropellerBearingBlockMixin {
    @Shadow
    @Final
    private static void use$lambda$0(PropellerBearingBlockEntity te) {}
    ...
    private InteractionResult use(
        ...
        if (!(blockEntity instanceof PropellerBearingBlockEntity pbbe))
            return InteractionResult.FAIL;
