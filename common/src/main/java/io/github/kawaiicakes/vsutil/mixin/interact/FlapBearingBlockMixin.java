...
@Pseudo
@Mixin(FlapBearingBlock.class)
public abstract class FlapBearingBlockMixin {
    @Shadow
    @Final
    private static void use$lambda$0(FlapBearingBlockEntity te) {}
    ...
    private InteractionResult use(
        ...
        if (!(blockEntity instanceof FlapBearingBlockEntity pbbe))
            return InteractionResult.FAIL;
